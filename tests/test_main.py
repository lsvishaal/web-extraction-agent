...
async def test_handler_initialization():
    ...
    with (
        ...
        patch("web_extraction_agent.main.initialize_config", new_callable=AsyncMock),
        patch("web_extraction_agent.main.initialize_tools", new_callable=AsyncMock),
        patch("web_extraction_agent.main.initialize_agent", new_callable=AsyncMock),
        patch("web_extraction_agent.main.run_agent", new_callable=AsyncMock, return_value=mock_response),
